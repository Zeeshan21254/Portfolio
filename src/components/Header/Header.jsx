        ...
        <div className="container">
          <div className="st-main-header-in">
            <div className="st-main-header-left">
              <Link className="st-site-branding" to='/' id="hero"><span style={{ color: "#fec544", fontWeight: "bold", fontSize: "22px" }} >Zee</span><span style={{ fontWeight: "bold", fontSize: "22px" }}>shan</span></Link>
            </div>
            <div className="st-main-header-right">
              <div className="st-nav">
                ...
                <div className="sp-phone">
                  ...
                  <div className="sp-phone-no">+971 58 253 9676</div>
                </div>
              </div>
            </div>
          </div>
